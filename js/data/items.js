...
export const ITEM_DEFS = {
  ...
  iron_sword: { id: 'iron_sword', name: 'Iron Sword', stack: 1,  desc: '18 damage · 2 block reach', weapon: { damage: 18, range: 32, arc: 1.5, cooldown: 0.36, projectileChip: 5, name: 'Iron Sword' } },
 ...
 */
export const FIST = { damage: 0, range: 20, arc: 1.2, cooldown: 0.3, projectileChip: 2, name: 'Fists', isFist: true };
